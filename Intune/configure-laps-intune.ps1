...
(
    [string]$name = "LapsDog",
    [string]$AssignmentTarget = "AllDevices", # New parameter with default value
    [string]$GroupId                           # New parameter for Group ID
)
...
#$newPasswordPs1Path = "https://gist.githubusercontent.com/gravejester/d95965c116b0d230db43/raw/78bc1c0f0739ecbc378aade5d0d806f5eb63c899/New-Password.ps1"

$newPasswordScriptContent = Invoke-RestMethod -Uri "https://gist.githubusercontent.com/gravejester/d95965c116b0d230db43/raw/78bc1c0f0739ecbc378aade5d0d806f5eb63c899/New-Password.ps1"
Invoke-Expression $newPasswordScriptContent
	...
	"omaSettings": [
		{
			...
			"description": "Create LapsDog and set password",
...
if ($AssignmentTarget -eq "AllDevices") {
    $assignjson = @"
{
    "assignments": [
        {
...
elseif ($AssignmentTarget -eq "Group" -and $GroupId) {
    $assignjson = @"
{
    "assignments": [
        {
...
"@
    ...
    throw "Invalid AssignmentTarget or missing GroupId."
}
...
$lapsjson = @"
{
	"description": "Uses LapsDog created via custom OMA-URI policy",
	"name": "LAPS Config",
	"platforms": "windows10",
	"roleScopeTagIds": [
		"0"
...
#$orgInfo = Invoke-MgGraphRequest -Method GET -Uri "https://graph.microsoft.com/v1.0/organization"
